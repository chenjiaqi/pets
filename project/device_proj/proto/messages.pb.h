...
typedef enum _FrameType {
    FrameType_E_FRAME_TYPE_REQUEST = 1,
    FrameType_E_FRAME_TYPE_RESPONSE = 2
} FrameType;
#define _FrameType_MIN FrameType_E_FRAME_TYPE_REQUEST
#define _FrameType_MAX FrameType_E_FRAME_TYPE_RESPONSE
#define _FrameType_ARRAYSIZE ((FrameType)(FrameType_E_FRAME_TYPE_RESPONSE+1))
...
typedef PB_BYTES_ARRAY_T(230) RequestMessage_params_t;
...
#define RespGetdataParams_init_default           {0, {StoreInformation_init_default, StoreInformation_init_default, StoreInformation_init_default, StoreInformation_init_default, StoreInformation_init_default, StoreInformation_init_default, StoreInformation_init_default, StoreInformation_init_default, StoreInformation_init_default, StoreInformation_init_default, StoreInformation_init_default, StoreInformation_init_default, StoreInformation_init_default, StoreInformation_init_default, StoreInformation_init_default, StoreInformation_init_default, StoreInformation_init_default, StoreInformation_init_default, StoreInformation_init_default, StoreInformation_init_default}}
...
#define RespGetdataParams_init_zero              {0, {StoreInformation_init_zero, StoreInformation_init_zero, StoreInformation_init_zero, StoreInformation_init_zero, StoreInformation_init_zero, StoreInformation_init_zero, StoreInformation_init_zero, StoreInformation_init_zero, StoreInformation_init_zero, StoreInformation_init_zero, StoreInformation_init_zero, StoreInformation_init_zero, StoreInformation_init_zero, StoreInformation_init_zero, StoreInformation_init_zero, StoreInformation_init_zero, StoreInformation_init_zero, StoreInformation_init_zero, StoreInformation_init_zero, StoreInformation_init_zero}}
...
#define RespGetdataParams_size                   580
#define RespGetDeviceParams_size                 32
#define RequestMessage_size                      239
